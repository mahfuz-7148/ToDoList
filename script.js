...
document.getElementById("addTask").addEventListener("click", () => {
  if (!inputBox.value.trim()) {
    ...
    li.innerHTML = `
                    ...
                    <span class="gap-5">
                        <button class="edit text-white px-4 py-2 rounded-lg hover:bg-slate-200 cursor-pointer"><img class = 'edit' src="./iconImage/edit.png" alt=""></button>
                        <button class="delete text-white px-4 py-2 rounded-lg hover:bg-slate-200 cursor-pointer"><img class = 'delete'  src="./iconImage/delete.png" alt=""></button>
                    </span>`;
...
ListContainer.addEventListener("click", (ev) => {
  ...
  if (ev.target.classList.contains("delete")) {
    ...
    <button class="delete text-white px-4 py-2 rounded-lg hover:bg-slate-200 cursor-pointer">
    <img class="delete" src="./iconImage/delete.png">
    </button>
    </span>`;
  } else if (ev.target.classList.contains("save")) {
    let newText = li.querySelector(".editInput").value.trim();

    li.innerHTML = `<span class='font-medium text-xl bg-blue-300 px-4 py-2 rounded-lg'>
    ${newText}</span>
    <span class="gap-5">
    <button class="edit text-white px-4 py-2 rounded-lg hover:bg-slate-200 cursor-pointer">
    <img class="edit" src="./iconImage/edit.png">
    </button>
    <button class="delete text-white px-4 py-2 rounded-lg hover:bg-slate-200 cursor-pointer">
    <img class="delete" src="./iconImage/delete.png">
    </button>
